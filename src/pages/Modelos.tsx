    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-pink-100 to-pink-300 text-gray-800">
      ...
      <div className="max-w-7xl mx-auto space-y-12 px-6 sm:px-8">
        {[
          ...
          <div key={index} className={`flex items-center gap-6 ${index % 2 === 0 ? "" : "flex-row-reverse"}`}>
            <img src={modelo.img} alt={modelo.nome} className="w-40 h-40 object-cover rounded-full border-4 border-pink-400 shadow-lg" />
            <div>
      ...
      <div className="max-w-7xl mx-auto space-y-12 px-6 sm:px-8 mt-8">
        ...
        <div className="flex items-center gap-6">
          <img src="https://i.ibb.co/q979NRQ/Remove-bg-ai-1737810940219.png" alt="Correção de sobrancelha" className="w-40 h-40 object-cover rounded-full border-4 border-pink-400 shadow-lg" />
          <div>
        ...
        <div className="flex items-center gap-6 flex-row-reverse">
          <img src="https://i.ibb.co/VqHRLjg/Remove-bg-ai-1737834159090.png" alt="Remoção de cílios" className="w-40 h-40 object-cover rounded-full border-4 border-pink-400 shadow-lg" />
          <div>
        ...
        {/* Maquiagem */}
        <div className="flex items-center gap-6">
          <img src="https://i.ibb.co/MBmPRYg/Remove-bg-ai-1737834145392.png" alt="Maquiagem" className="w-40 h-40 object-cover rounded-full border-4 border-pink-400 shadow-lg" />
          <div>
